...
KCHAIR2:    BLE    V8,vdac16(0.01),KCHAIREX ;check if we're within our epsilon
            ...
            DAC    1,-0.02          ;vel for positive pos     ***-to+ HP 12/1/15 D253
            JUMP   KCHAIR1

KCHAIR3:    DAC    1,0.02         ;vel for negative pos        ***-to+ HP 12/1/15 D253
            JUMP   KCHAIR1
...
KDRUM2:     BLE    V8,vdac16(0.01),KDRUMEX
            ...
            DAC    0,0.02         ;vel for positive pos      ***HP+-   for D253 3/3/16
            JUMP   KDRUM1
