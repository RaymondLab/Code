...
WAVELENGTH = 499;
% path to file
file = 'Z:\1_Maxwell_Gagnon\RuthProjectData\2017_11_09\x0 light and dark at 2Hz FOM 1.smr';
...
figure(3)
plot(offMean,'r')
title('All Light OFF Waveforms and Thier Mean')

figure(2)
plot(onMean,'r')
title('All Light ON Waveforms and Thier Mean')
