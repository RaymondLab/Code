...
LASERON: 'Z DIGOUT [......1.]
            JUMP   OFFST1    ;LOOP 'changed by Ruth to turn on digital Port 2, for FOM ON'
...
SPULSE2:    DIGOUT [.....1..]      ; 1 -  changed by  RUth to produce TTL3 on stim pulse
            ...
            ;DELAY  PulseSta
            MOV    V10,PulseNum
SPULSE3:    DIGOUT [.....1..]        ;% changed to 0 by Ruth 061217 to turn on TTL2 output in pulse config 
            DELAY  PulseDur
            DIGOUT [.....0..]
            DELAY  PulseInt
            DBNZ   V10,SPULSE3
...
;----------------------------------------------------
KSPULSE: 'p DIGOUT [.....000]      ;set digital outputs low 
            JUMP   LOOP
;-----------------------------------------------------------------------------
