...
KCHAIR2:    BLE    V8,vdac16(0.01),KCHAIREX ;check if we're within our epsilon
            ...
            DAC    1,0.02          ;vel for positive pos     ***changed to + from - for D19 06262018
            JUMP   KCHAIR1

KCHAIR3:    DAC    1,-0.02         ;vel for negative pos        ***changed to - from + for D019 06262018
            JUMP   KCHAIR1
...
KDRUM2:     BLE    V8,vdac16(0.01),KDRUMEX
            ...
            DAC    0,-0.02         ;vel for positive pos      ***PG changed to - for D019 06262018
            JUMP   KDRUM1

KDRUM3:     DAC    0,0.02          ;vel for negative position  *** PG changed to + for D019 06262018
            JUMP   KDRUM1
...
;Set step command to move chair and drum with opto stimulation  - needs fixing 
;-----------------------------------------------------------------------------
STEPS:  'u  DAC    0,SAmpD
            DAC    1,SAmpC
            DIGOUT [.......1]
...
SPULSE0: 'P SZ     0,DrumAmp       ;set cosine amplitude
            ...
            DIGOUT [....00..] ;   Can later change this to 11 to get overlapping pulses ;might need to change to [......00]
