...
;-----------------------------------------------------------------------------
; LIGHTON: modified 1/20/14 for Rig D019 changed by ruth 10/11/17 then added here on Hannahs rig o tun LED liht and FOM on and off 11/22/17 
LIGHTON: 'L DIGOUT [.......1]
            JUMP   OFFST1    ;LOOP 'changed by Ruth to turn on digital Port 0, for LIGHT ON, TTL 1'

LIGHTOFF: 'l DIGOUT [.......0]
            JUMP   OFFST1    ;LOOP 'changed by Ruth to turn on digital Port 0, for LIGHT ON, TTL 1'
;-----------------------------------------------------------------------------
; LASERON: turn on both lasers changed by Ruth 10/11/17
LASERON: 'Z DIGOUT [......1.]
            JUMP   OFFST1    ;LOOP 'changed by Ruth to turn on digital Port 2, for FOM ON, TTL 3 changed to prevent interference with pulse config 061217'

LASEROFF: 'z DIGOUT [......0.]
            JUMP   OFFST1    ;LOOP 'changed by Ruth to turn on digital Port 2, for FOM ON TTL 3 changed as above 061217'
...
SPULSE2:    DIGOUT [.......1]      ; 1 -     
            ...
            ;DELAY  PulseSta
            MOV    V10,PulseNum
SPULSE3:    DIGOUT [......0.]        ;% changed to 0 by Ruth 061217 to turn off TTL2 output in pulse config 
            DELAY  PulseDur
            DIGOUT [......0.]
            DELAY  PulseInt
            DBNZ   V10,SPULSE3
