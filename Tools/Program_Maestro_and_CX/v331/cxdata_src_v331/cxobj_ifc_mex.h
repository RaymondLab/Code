...
//=====================================================================================================================
// NOTES: As of Maestro v2.0, old FBPARMS replaced by RMVTGTDEF, defined in RMVIDEO_COMMON.H. As of Maestro 2.5, new 
// fields added to RMVTGTDEF. These changes impact the structures U_TGPARMS and CXTARGET. The deprecated versions of
// U_TGPARMS are defined here to support document schema migration. See CXFILEFMT.H for deprecated versions of CXTARGET; 
// these are needed for parsing Maestro data files generated by older Maestro versions...
//
