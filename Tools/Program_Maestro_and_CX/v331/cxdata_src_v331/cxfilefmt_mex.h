...
#define CXH_EXTRAS               364                  // # of unused shorts in header record
#define CXH_CURRENTVERSION       20                   // the current version # (as of Maestro version 3.2.0)
...
//       N  0  0  0  0  0  0  0        Sorted spike train records appended to data file by analysis programs (N=8..57)
//
...
typedef struct tagCxFileRec                           // generic format for Maestro file data/info records
{
   ...
   union                                              // the data, in various forms...
   {
      ...
      CXFILETGT tgts[CX_RECORDTARGETS];               //    for CX_TGTRECORD, v >= 13
