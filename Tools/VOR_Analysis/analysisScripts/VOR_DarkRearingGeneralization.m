function VOR_DarkRearingGeneralization(params)
...
labels = strcat(T.Type, {' '}, num2str( T.Frequency), { 'Hz '}, num2str( T.TimePoint ));
...
result = VORsineFit_DarkRearingGeneralization(data, T.StartTime, T.EndTime, T.Frequency, labels, T.TimePoint,velthres, ploton);
