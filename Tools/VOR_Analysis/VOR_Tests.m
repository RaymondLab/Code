...
function singleAnalysis(params)
    ...
    switch params.analysis
        ...
        case 'Sriram_OKR'
            ...
            VOR_Summary_Sriram_CycleDiff(params, [58, 59, 60], [5, 6, 7], 'T60 - T0', 'drum');
            VOR_Summary_Sriram_CycleDiff(params, [13, 14, 15], [5, 6, 7], 'T15 - T0', 'drum');
            VOR_Summary_Sriram_CycleDiff(params, [58, 59, 60], [13, 14, 15], 'T60 - T15', 'drum');
