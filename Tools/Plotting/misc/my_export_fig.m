...
%
% type is usually unnecessary (leave empty) if extension is provided
%
% Hannah Payne
% 9/2017
...
%
% p = inputParser;
% p.addOptional('f_handle', gcf, @(x) true);
% p.addOptional('filename', 'figure.pdf', @ischar);
% p.addOptional('type', [], @ischar);
% p.addOptional('pad', 0, @isnumeric);
% p.parse(varargin{:});
%
%
% f_handle = p.Results.f_handle;
