...
%% Camera 1
hold(app.UIAxes3, 'on')
hp(3) = plot(app.UIAxes3, results.time1, results.cr1a(:,2),'b-'); hold on;
hp(1) = plot(app.UIAxes3, results.time1, results.pupil1(:,1),'r-'); hold on
hp(2) = plot(app.UIAxes3, results.time1, results.cr1a(:,1),'k-');

xlim(app.UIAxes3, [results.time2(1+1) results.time2(end-1)]); box off
...
plot(app.UIAxes3_2, results.time2,results.cr2b(:,2),'b-'); hold on;
plot(app.UIAxes3_2, results.time2, results.pupil2(:,1),'r-'); hold on;
plot(app.UIAxes3_2, results.time2,results.cr2b(:,1),'k-');

xlim(app.UIAxes3_2, [results.time2(1) results.time2(end)]); box off
